...
class BikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bike" do
    assert_difference('Bike.count') do
      post bikes_url, params: { bike: { bike_index_id: @bike.bike_index_id, user_id: @bike.user_id } }
    end
  ...
  test "should update bike" do
    patch bike_url(@bike), params: { bike: { bike_index_id: @bike.bike_index_id, user_id: @bike.user_id } }
